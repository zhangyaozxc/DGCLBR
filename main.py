...
def main():
    ...
    #  metric
    metrics = [Recall(20), NDCG(20), Precision(20), Recall(40), NDCG(40), Precision(40), Recall(80), NDCG(80),
               Precision(80)]
    ...
    for lr, decay, message_dropout, node_dropout \
        ...
        info = mymodel_Info(64, decay, message_dropout, node_dropout, 2)
        model = mymodel(info, assist_data, graph, device).to(device)
